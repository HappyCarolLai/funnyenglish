const data = {
  ...
  beneath2: {
    ...
    meaning: "在下；向下",
    pos: "adv.",
    sentence: "The roots grow beneath the surface.",
    translation: "根部在地面下生長。"
  },
  conclude1: {
    word: "conclude(vt.)",
    meaning: "結束；推斷出",
  ...
  conclude2: {
    word: "conclude(vi)",
    meaning: "結束，終了（+with）；斷定",
    pos: "vi.",
    sentence: "The concert will conclude at 10 PM.",
    translation: "音樂會將於晚上10點結束。"
  },
  elbow1: {
    word: "elbow(n.)",
    meaning: "手肘",
  ...
  grasshopper2: {
    ...
    meaning: "見異思遷的人；小角色",
    pos: "v.",
    sentence: "He’s just a grasshopper in the big world.",
    translation: "他在這個大世界裡只是一個小角色。"
  },
  juicy: {
    word: "juicy",
    meaning: "多汁的",
  ...
  monster2: {
    ...
    meaning: "巨大的東西；可怕的事物",
    pos: "adj.",
    sentence: "The project turned into a monster.",
    translation: "這個計畫變得龐大而難以控制。" 
  },
  present1: {
    word: "present(n.)",
    meaning: "禮物",
